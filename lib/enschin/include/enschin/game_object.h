...
protected:
    ...
    b2Body* body;
public:
    GameObject(const UpdateContext& ctx, const std::string name, const Model* model, const SpriteSheet* sprite, Vec2 pos, bool fixedRotation=false, bool collision=true, bool isStatic=false, float gravity = 1.0f, float density = 1.0f, float friction = 0.3f);
    GameObject(const UpdateContext& ctx, const std::string name, const Model* model, const Color* c, Vec2 pos, bool fixedRotation=false, bool collision=true, bool isStatic=false, float gravity = 1.0f, float density = 1.0f, float friction = 0.3f);
    GameObject(const UpdateContext& ctx, const std::string name, const Model* model, Vec2 pos, bool fixedRotation=false, bool collision=true, bool isStatic=false, float gravity = 1.0f, float density = 1.0f, float friction = 0.3f);
    ~GameObject();
